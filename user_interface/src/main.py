...
def main(page: ft.Page):
    ...
    def pick_files_result(e: ft.FilePickerResultEvent):
        if e.files:
            ...
            selected_files.update()
        page.own_frame = selected_img.src
    ...
    def call_thumbnail_generation(style, model_selection):
        ...
        thumbnail = ft.Image(src=thumbnail_src, width=1000, height=1000, fit=ft.ImageFit.CONTAIN)
    ...
    def thumbnail_generation(style, model_selection, best_frame):
        ...
        page.add(ft.Text(f"Stable Diffusion creating the cartoonish version with prompt: {frame_prompt}", size=15))
