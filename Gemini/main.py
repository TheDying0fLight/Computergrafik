...
response_pos = model.generate_content(
    """
    Generate a positive prompt for stable diffusion of the following text. Please be simple and direct.
    The text: 
    """
    + transcript
)
...
response_neg = model.generate_content(
    """
    Generate a negative prompt for stable diffusion of the following text. Please be simple and direct.
    The text: 
    """
    + transcript
)
print(response_neg.text)
